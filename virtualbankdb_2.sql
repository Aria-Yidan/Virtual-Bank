...
--
-- Table structure for table `mybank_mymessage`
--

DROP TABLE IF EXISTS `mybank_mymessage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mybank_mymessage` (
  `UserID` varchar(100) NOT NULL,
  `Num` int(11) NOT NULL,
  PRIMARY KEY (`UserID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `mybank_mymessage`
--


/*!40000 ALTER TABLE `mybank_mymessage` DISABLE KEYS */;
/*!40000 ALTER TABLE `mybank_mymessage` ENABLE KEYS */;


--
-- Table structure for table `mybank_newmessage`
--

DROP TABLE IF EXISTS `mybank_newmessage`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mybank_newmessage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Date` varchar(30) NOT NULL,
  `Data` varchar(500) NOT NULL,
  `Type` tinyint(1) NOT NULL,
  `Belong_id` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `myBank_newmessage_0e6556d3` (`Belong_id`),
  CONSTRAINT `Belong_id_refs_UserID_3a109d29` FOREIGN KEY (`Belong_id`) REFERENCES `mybank_mymessage` (`UserID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mybank_newmessage`
--


/*!40000 ALTER TABLE `mybank_newmessage` DISABLE KEYS */;
/*!40000 ALTER TABLE `mybank_newmessage` ENABLE KEYS */;
...
-- Dump completed on 2016-05-07 20:11:34
